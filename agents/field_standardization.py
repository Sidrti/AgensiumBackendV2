    ...
    try:
        ...
        standardization_data = {
            ...
            "defaults": {
                ...
                "normalize_internal_spacing": True,
                "apply_synonyms": True,
                "unit_standardization": False,
                "date_standardization": True,
                "target_date_format": "%Y-%m-%d",
                "standardization_effectiveness_weight": 0.5,
            ...
            "overrides": {
                ...
                "preserve_columns": parameters.get("preserve_columns"),
                "synonym_mappings": parameters.get("synonym_mappings"),
                "unit_mappings": parameters.get("unit_mappings"),
                "case_strategy": parameters.get("case_strategy"),
                "trim_whitespace": parameters.get("trim_whitespace"),
                "normalize_internal_spacing": parameters.get("normalize_internal_spacing"),
                "apply_synonyms": parameters.get("apply_synonyms"),
                "unit_standardization": parameters.get("unit_standardization"),
                "date_standardization": parameters.get("date_standardization"),
                "target_date_format": parameters.get("target_date_format"),
                "standardization_effectiveness_weight": parameters.get("standardization_effectiveness_weight"),
