    ...
    try:
        ...
        data = {
            ...
            "defaults": {
                ...
                "value_column": None,
                "rfm_recency_weight": 33,
                "rfm_frequency_weight": 33,
                "rfm_monetary_weight": 34,
                "rfm_bins": 5,
            ...
            "overrides": {
                ...
                "custom_start_date": parameters.get("custom_start_date"),
                "custom_end_date": parameters.get("custom_end_date"),
                "metric": parameters.get("metric"),
                "segment_count": parameters.get("segment_count"),
                "customer_id_column": parameters.get("customer_id_column"),
                "transaction_date_column": parameters.get("transaction_date_column"),
                "value_column": parameters.get("value_column"),
                "rfm_recency_weight": parameters.get("rfm_recency_weight"),
                "rfm_frequency_weight": parameters.get("rfm_frequency_weight"),
                "rfm_monetary_weight": parameters.get("rfm_monetary_weight"),
                "rfm_bins": parameters.get("rfm_bins"),
