...
def execute_cleanse_writeback(
    ...
    try:
        ...
        writeback_data = {
            ...
            "defaults": {
                "verify_numeric_types": True,
                "verify_datetime_types": True,
                "verify_no_new_nulls": True,
                "verify_no_duplicates": True,
                "verify_data_retention": True,
                "generate_comprehensive_manifest": True,
                "include_transformation_summary": True,
                "original_row_count": None,
                "original_column_count": None,
                "integrity_weight": 0.4,
                "completeness_weight": 0.3,
                "auditability_weight": 0.3,
                "excellent_threshold": 95,
                "good_threshold": 85
            },
            "overrides": {
                "verify_numeric_types": parameters.get("verify_numeric_types"),
                "verify_datetime_types": parameters.get("verify_datetime_types"),
                "verify_no_new_nulls": parameters.get("verify_no_new_nulls"),
                "verify_no_duplicates": parameters.get("verify_no_duplicates"),
                "verify_data_retention": parameters.get("verify_data_retention"),
                "generate_comprehensive_manifest": parameters.get("generate_comprehensive_manifest"),
                "include_transformation_summary": parameters.get("include_transformation_summary"),
                "agent_manifests": parameters.get("agent_manifests"),
                "original_row_count": parameters.get("original_row_count"),
                "original_column_count": parameters.get("original_column_count"),
                "integrity_weight": parameters.get("integrity_weight"),
                "completeness_weight": parameters.get("completeness_weight"),
                "auditability_weight": parameters.get("auditability_weight"),
