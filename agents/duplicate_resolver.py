...
def execute_duplicate_resolver(
    ...
    try:
        ...
        dedup_data = {
            ...
            "defaults": {
                "detection_types": ["exact", "case_variations", "email_case", "missing_values", "conflicting"],
                "email_columns": [],
                "key_columns": [],
                "merge_strategy": "remove_duplicates",
                "null_handling": "ignore_nulls",
                "conflict_resolution": "keep_first",
                "dedup_reduction_weight": 0.5,
            ...
            "overrides": {
                ...
                "merge_strategy": parameters.get("merge_strategy"),
                "null_handling": parameters.get("null_handling"),
                "conflict_resolution": parameters.get("conflict_resolution"),
                "dedup_reduction_weight": parameters.get("dedup_reduction_weight"),
