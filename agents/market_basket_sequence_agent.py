    ...
    try:
        ...
        data: Dict[str, Any] = {
            ...
            "overrides": {
                ...
                "support": parameters.get("support"),
                "confidence": parameters.get("confidence"),
                "lift": parameters.get("lift"),
                "gap_days": parameters.get("gap_days"),
                "top_n_rules": parameters.get("top_n_rules"),
                "transaction_id_column": parameters.get("transaction_id_column"),
                "product_id_column": parameters.get("product_id_column"),
                "customer_id_column": parameters.get("customer_id_column"),
                "timestamp_column": parameters.get("timestamp_column"),
                "min_items_per_transaction": parameters.get("min_items_per_transaction"),
                "max_itemset_length": parameters.get("max_itemset_length"),
