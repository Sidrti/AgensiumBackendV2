"""
Profile My Data Downloads Module (Refactored)
...
class ProfileMyDataDownloads(BaseDownloader):
    ...
    def _create_profiler_sheet(self, wb, agent_output):
        ...
        ws = wb.create_sheet("Profiler")
        self.styler.set_column_widths(ws, [25, 15, 12, 12, 12, 12, 50])
    ...
    def _create_drift_sheet(self, wb, agent_output):
        ...
        ws = wb.create_sheet("Drift Detection")
        self.styler.set_column_widths(ws, [25, 15, 12, 15, 15, 50])
    ...
    def _create_risk_sheet(self, wb, agent_output):
        ...
        self.styler.set_column_widths(ws, [25, 12, 12, 15, 50])
