...
class ProfileNotFoundException(AuthException):
    """Exception when user profile is not found."""
...
class HandleTakenException(AuthException):
    """Exception when a requested handle is already taken."""
...
class InvalidHandleException(AuthException):
    """Exception for invalid handle format."""
